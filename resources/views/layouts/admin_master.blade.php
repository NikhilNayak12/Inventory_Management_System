...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; TheCreativeError</div>
                            <div>
        ...
        <script src="{{ secure_asset('backend') }}/assets/demo/chart-area-demo.js"></script>
        <script src="{{ secure_asset('backend') }}/assets/demo/chart-bar-demo.js"></script>
        <!-- <script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
        <script src="https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script> -->
         <!-- <script src="{{ secure_asset('backend') }}/assets/demo/datatables-demo.js"></script>  -->
<!-- 
